...
use incrededup::{
    resolve_transitivity, run_dedupe, run_disk_dedupe, DbConfig, DbPool, DedupeConfig,
    EdgeLookupMode, FilteredParentStore, MatchStore,
};
...
struct Args {
    ...
    #[arg(long)]
    build_adjacency: Option<PathBuf>,
    ...
    search_index_error_backoff_secs: u64,
}
